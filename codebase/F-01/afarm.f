...
: INIT  BLACK bcolor WHITE fcolor  600 370 wsize  "TITLE" wtitle  page
	...
	." Animal Farm  by  cartheur, programmed in polyForth" CR CR
	." Animal Farm is a program that creates an evolution " CR
	." of an ecosystem consisting of entities with different features: " CR
	." e=energy a=attacking force d=defensive force  s=speed " CR
	." Character='species': a+4*d+10*s -> 0-25=A-Z" CR 
